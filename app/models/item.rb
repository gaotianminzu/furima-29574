class Item < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :cost, format: { with: /\A[0-9]+\z/, message: 'Half-width number'},numericality: { greater_than_or_equal_to: 300, less_than: 10000000 , message: "is out of setting range"}
